...
const openModalSelectOrder = ref(false)
...
<template>
  ...
  <v-slide-x-transition hide-on-leave leave-absolute>
    ...
    <div class="containerLayout" v-if="createOrder">
      <OrderCreateOrderPage
        ...
        @select-data="openModalSelectOrder = true"
      />
    </div>
  ...
  <OrderModalSelectOrder
    ...
    @on-close="openModalSelectOrder = false"
  />
...
.icon-prepend > .v-btn__prepend {
  @apply ms-0 me-0;
}

.icon-prepend > .v-btn__prepend > i {
  @apply !mx-2;
}
</style>
